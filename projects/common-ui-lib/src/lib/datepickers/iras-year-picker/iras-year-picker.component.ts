...
export class IrasYearPickerComponent extends DatePickerUtilities implements OnInit {
  ...
  @ViewChild('yearPickerContainerElementRef') yearPickerContainerElementRef: ElementRef;
