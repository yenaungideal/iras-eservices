...
describe('AmountInputComponent', () => {
  ...
  it('#writeValue should include the value with comma separator', () => {
    component.type = 'amount';
    fixture.detectChanges();
    component.writeValue('1000000.00');
    expect(component.value).toEqual('1,000,000.00');
  });

  it('#writeValue should include the value with comma separator for amountFilter', () => {
    component.type = 'gridAmountFilter';
    component.decimalLength = 5;
    fixture.detectChanges();
    component.writeValue('1000000.12346');
    expect(component.value).toEqual('1,000,000.12346');
  });
});
