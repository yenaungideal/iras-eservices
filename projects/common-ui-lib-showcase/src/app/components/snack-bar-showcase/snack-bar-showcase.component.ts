...
export class SnackBarComponentShowcaseComponent implements OnInit, OnDestroy {
  ...
  snackBarButtonClick() {
    this.snackBarService.openSnackBar({
      data: {
        title: 'Message Sent',
        description: `The <strong>Inland <span id="revenueText">Revenue</p> Authority of Singapore (IRAS)</strong> is the main tax administrator to the Government.<ul>Things it does: <li>Collects tax</li><li>Helps negotiate treaty</li><li>many more...</li></ul>
    ...
    fromEvent(document.getElementById('revenueText'), 'click')
      .pipe(take(1))
      .subscribe((ev) => {
        console.log(ev);
      });
